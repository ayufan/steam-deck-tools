...
namespace ExternalHelpers
{
    public class WindowsDarkMode
    {
        ...
        {
            monitor.RegChanged += new EventHandler((o, e) => { UpdateIsDarkModeEnabled(); });
            monitor.Start();
        }

        private static void UpdateIsDarkModeEnabled()
        {
    ...
    // This RegistryMonitor class was written by CodeProject
